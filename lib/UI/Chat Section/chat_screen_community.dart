...
class ChatScreenCommunity extends StatefulWidget {
  String chatRoomId;
  String title;
  String type;
  ...
  @override
  _ChatScreenCommunityState createState() => _ChatScreenCommunityState();
}

class _ChatScreenCommunityState extends State<ChatScreenCommunity> {
